    ...
    <div className="h-screen w-screen bg-[#0b0e14] text-white p-6 font-sans flex flex-col overflow-hidden">
      <main className="max-w-[1440px] w-full h-full mx-auto flex flex-col gap-5 overflow-hidden min-h-0">
        ...
        <header className="flex justify-between items-center bg-[#1e2130]/50 backdrop-blur-md p-4 rounded-2xl border border-white/10 shrink-0">
          <h1 className="text-xl font-bold bg-gradient-to-r from-blue-400 to-green-400 bg-clip-text text-transparent ">Dashboard </h1>
          <div className="flex items-center gap-4">
            <div className="w-9 h-9 rounded-full bg-gradient-to-tr from-orange-500 to-red-600 animate-pulse shadow-[0_0_10px_orange]"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 flex-[4] min-h-0">
          ...
          <section className="md:col-span-2 bg-[#12141d] p-6 rounded-3xl border border-white/5 flex flex-col justify-between overflow-hidden">
            <h3 className="text-md font-bold flex items-center gap-2 shrink-0">
              <span className="w-2 h-2 rounded-full bg-green-500 animate-ping"></span>
            SHIFT TRACKER
            </h3>
            
            <div className="w-full flex flex-col justify-center flex-grow min-h-0">
              ...
              <div className="grid grid-cols-7 gap-2 flex-grow min-h-0">
                {calendarData.map((item) => (
                  <motion.button
                    ...
                    className={`rounded-xl flex items-center justify-center font-bold text-xs transition-all w-full h-full min-h-[32px] max-h-[46px] ${
                      ...
                      'bg-[#1e2130] hover:bg-blue-500/20'
                    }`}
                  >
                    {item.day}
                  </motion.button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 flex-[5] min-h-0">
          <section className="md:col-span-2 bg-[#1e2130] p-6 rounded-3xl border border-white/5 shadow-[0_0_20px_rgba(0,0,0,0.5)] flex flex-col overflow-hidden">
